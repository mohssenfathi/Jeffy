...
//        NSDictionary *metadata = [[asset_ defaultRepresentation] metadata];
    ...
    func parseExifMetadata(_ exifMetadata: [String: AnyObject], formattedMetadata: inout [[String : Any]]) {
    ...
    func parseTiffMetadata(_ tiffMetadata: [String: AnyObject], formattedMetadata: inout [[String : Any]]) {
...
//    MARK: - Formatting
    ...
    func formatShutterSpeed(_ duration: Float) -> String {
        ...
        let denominator = Int(1.0/duration)
        return "1/" + String(denominator) + " s"
    }
